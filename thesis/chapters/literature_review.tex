...
This section will summarize our findings in academia. It begins with a short presentation of papers found followed by a summary and analysis of the tests found within the papers.
...
It is therefore our conclusion in regards to RQ1-2 that the current body of knowledge is inaccurate and outdated however there is enough history for us to be able to start fresh.
