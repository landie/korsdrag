...
The literature review has been focused on what the academic world knows and what the industrial world knows. Knowledge in the case of this thesis being focused at performance tests.
...
%TODO: "...makes the test outdated since..." ska det var testen som är utdaterade i sig eller är det testresultaten?
...
% TODO: beskriv hur testen var "biased", inte bara att de var det (annars kommer examinator gnälla :P).
