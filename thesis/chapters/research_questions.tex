...
\begin{itemize}
	\item RQ1: What is the state of the art knowledge of ESBs in academic literature publications?
	\item RQ2: What is the state of the art knowledge of ESBs in industrialgi literature publications?
	\item RQ3: What are the components of a reproducable and accurate ESB performance testing framework?
\end{itemize}
...
a quick look through the actual content to see if the abstract did indeed sum up the paper in a correct and fair way. 
If then the quick view through the paper gave any value it was read more thoroughly and then added to the list of accepted papers to use.
