...
\begin{itemize}
	...
	\item R3: How accurate and up to date is our current knowledge, what has been done and how?
\end{itemize}
...
Läste abstract, skummade igenom  thesis för att se om där fanns något intressant, om något intressant funnes så läste lite djupare och om det lät vettigt så hamnade skiten här
...
%If you are planning to do a interview or survey you should present what questions u going to ask and how the questions will be formulated. You should also present who will be answering the questions and how many answers you are planning to receive.
