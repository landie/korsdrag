...
"Enterprise Service Bus: A Performance Evaluation" by Sanjay P. Ahuja and Amit Patel  is the only paper found that performs a perfomance test directly aimed at the differnt ESBs with a varied testsuite and varied measurements. Published in 2011 it is also the most recent paper found however all ESBs tested has received major updates since then and as such 
